package uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.elements;
...
public class Stylesheet extends ElementBuffer{
	...
	@Ooxelement()
	private uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.ctypes.OutputType Output = null;

	@Ooxnode(localName="PostProcessing",targetNamespace="http://www.idyria.com/osi/docbook/stylesheets")
	@Ooxelement()
	private uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.ctypes.PostProcessingType PostProcessing = null;
	 ...
	 */
	public uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.ctypes.OutputType getOutput(Boolean create) {

		if (this.Output == null && create)
			Output= new uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.ctypes.OutputType();
		return Output;
	}
	 ...
	 * @return value for the field : Output
	 */
	public uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.ctypes.OutputType getOutput() {
	 ...
	 */
	public void setOutput(uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.ctypes.OutputType Output) {
		this.Output=Output;
	}
	 ...
	 */
	public uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.ctypes.PostProcessingType getPostProcessing(Boolean create) {

		if (this.PostProcessing == null && create)
			PostProcessing= new uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.ctypes.PostProcessingType();
	 ...
	 * @return value for the field : PostProcessing
	 */
	public uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.ctypes.PostProcessingType getPostProcessing() {
	 ...
	 */
	public void setPostProcessing(uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.ctypes.PostProcessingType PostProcessing) {
