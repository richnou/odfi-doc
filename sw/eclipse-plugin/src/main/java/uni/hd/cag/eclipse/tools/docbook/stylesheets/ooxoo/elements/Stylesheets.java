...
public class Stylesheets extends ElementBuffer{
	...
	@Ooxelement()
	private uni.hd.cag.ooxoo.core.wrap.OOXList<uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.elements.Stylesheet> Stylesheet = null;
	 ...
	 */
	public uni.hd.cag.ooxoo.core.wrap.OOXList<uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.elements.Stylesheet> getStylesheet(Boolean create) {
		 ...
		 *
		 */
		class _nestedmultiple extends OOXList<uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.elements.Stylesheet> {

			public _nestedmultiple() {
				super(new NonNegativeIntegerBuffer(0),new MaxOccursBuffer(true));
			}

			public uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.elements.Stylesheet add() {
				uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.elements.Stylesheet o = new uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.elements.Stylesheet();
				this.addElement(o);
				return o;
			}
		}
	 ...
	 * @return value for the field : Stylesheet
	 */
	public uni.hd.cag.ooxoo.core.wrap.OOXList<uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.elements.Stylesheet> getStylesheet() {
	 ...
	 */
	public void setStylesheet(uni.hd.cag.ooxoo.core.wrap.OOXList<uni.hd.cag.eclipse.tools.docbook.stylesheets.ooxoo.elements.Stylesheet> Stylesheet) {
